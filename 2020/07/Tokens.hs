...
alex_table = listArray (0 :: Int, 1307)
  [ 0
  , 32
  , 32
  , 32
...
alex_check = listArray (0 :: Int, 1307)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 =  \_ -> TokenNoBags 
alex_action_1 =  \s -> TokenBag $ unwords $ take 2 $ words s 
alex_action_2 =  \_ -> TokenContain 
alex_action_3 =  \s -> TokenNBags $ read s 
alex_action_4 =  \s -> TokenComma 
alex_action_5 =  \_ -> TokenPeriod 
